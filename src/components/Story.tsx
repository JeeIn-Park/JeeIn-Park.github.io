    ...
    <section className="story-wrapper">
      ...
      <section className="story-section">
        ...
        >
          ...
          So, where does all this creativity go?
          Optimisation.
          I’m obsessed with simplifying things—finding shortcuts, streamlining workflows, and maximising effectiveness. That’s where my imagination gets to play in real life.

          This drive to improve things led me to join a gifted education programme. Most people there picked maths or science tracks. And sure—I love maths and science. I’m absolutely a nerd. But when I saw a course called “Invention”? BOOM. I knew immediately: this was where I belonged.

          On the application, I answered the hobbies section with one word: imagining.
          I go down rabbit holes in my head all the time—daydreaming about weird and wonderful ideas. The topics are endless, often unrealistic, but always fascinating.

          The entrance test was all about creativity and problem solving. Some said it was difficult. I didn’t even think about difficulty—I was too busy enjoying it. It felt like a series of puzzles. I ended up scoring first place and joined the programme.
          ...
          I started with physical tools and gadgets. Then macros. Then software projects. With every new experience, I saw more clearly, thought more widely, and got better at what I do.
      ...
      <section className="story-section">
        ...
        >
          My dream is simple:
          Transform the way people work by building smarter, simpler solutions that make a real impact.
          ...
          Short-Term (0–2 years): Build a strong technical foundation. Gain industry experience. Work on real-world problems, join open-source or hackathon projects, and improve efficiency through hands-on work in both frontend and backend systems.

          Medium-Term (3–5 years): Become an expert in human-centric design. Lead productivity-focused projects. Tackle complex problems with scalable, elegant solutions.

          Long-Term (6+ years): Shape the future of intelligent systems. Share insights, mentor others, and inspire new ways of thinking through public speaking or writing.

          Having the technical skills to build features is just the baseline.
          But innovation? That’s something else.
