...
export const SKILLS: Skill[] = [
  ...
  { name: "React", category: "application", color: "green", order: 1 },
  ...
  { name: "Jetpack Compose", category: "application", color: "green", order: 6 },
  ...
  { name: "Git", category: "platform", color: "orange", order: 1 },
  { name: "Firebase", category: "platform", color: "yellow", order: 2 },
  { name: "AWS", category: "platform", color: "peach", order: 3 },
  { name: "Vagrant", category: "platform", color: "blue", order: 4 },
  { name: "GitHub Actions", category: "platform", color: "orange", order: 5 },
  { name: "IntelliJ", category: "platform", color: "pink", order: 6 },
  { name: "VS Code", category: "platform", color: "blue", order: 7 },
  ...
  { name: "Rendering", category: "design", color: "blue", order: 5 },
  { name: "3D Graphics", category: "design", color: "lavender", order: 6 },
  { name: "MVVM", category: "design", color: "periwinkle", order: 7 },
  { name: "SRS", category: "design", color: "amber", order: 8 },
  { name: "AI", category: "design", color: "rose", order: 9 },
  { name: "Pathfinding", category: "design", color: "sky", order: 10 },
  { name: "Concurrency", category: "design", color: "green", order: 11 },
  { name: "Algorithms", category: "design", color: "orange", order: 12 }
];
